...
\includegraphics[width=\textwidth]{bobslide}
...
\begin{figure}[p]
\begin{minipage}[c]{\textwidth}
\includegraphics[width=\textwidth]{dressinggown}
...
\centering
\vfill
    \includegraphics[width=\textwidth]{wingsofwind1}
    \vfill
\end{figure}
...
{%
	...
	\begin{figure}[b!]
		\centering
		\includegraphics[width=\textwidth]{wingsofwind2}
...
\begin{figure}[p]
\begin{minipage}[c]{\textwidth}
\includegraphics[width=\textwidth]{streetghostsimproved}
...
\nopagebreak[4]
\begin{center}
\includegraphics[width=.9\textwidth]{handsmoney2}
