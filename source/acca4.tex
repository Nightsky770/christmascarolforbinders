\documentclass[paper=a5,BCOR=5mm,twoside,DIV=calc,12pt,usegeometry]{scrbook} % Document font size and paper size
%\documentclass[paper=a5,BCOR=15mm,twoside,DIV=15,headinclude=off,12pt,chapterprefix=off,openany,headings=huge]{scrbook} % Document font size and paper size
\usepackage{graphicx}
\usepackage{xcolor}
\usepackage{fontspec}
...
\newfontfamily\lettrinefont{Acorn Initials}
...
\addchap[Stave I: Marley's Ghost]{Stave One: Marley's Ghost}
\begin{figure}[h]
\centering
...
\addchap[Stave II: The First of the Three Spirits]{Stave Two: The First of the Three Spirits}
\begin{figure}[h]
\centering
...
\begin{minipage}[c]{\linewidth}
\includegraphics[width=.8\linewidth]{handsmoney}
\end{minipage}


\addchap[Stave III: The Second of the Three Spirits]{Stave Three: The Second of the Three Spirits}
\begin{minipage}[c]{\linewidth}
...
It is a fair, even-handed, noble adjustment of things, that while there is infection in disease and sorrow, there is nothing in the world so irresistibly contagious as laughter and good-humour. When Scrooge's nephew laughed in this way\textemdash holding his sides, rolling his head, and twisting his face into the most extravagant contortions\textemdash Scrooge's niece, by marriage, laughed as heartily as he. And their assembled friends, being not a bit behindhand, roared out lustily.
...
%\begin{figure}[tbh]
%\centering
%\includegraphics[width=\linewidth]{candleimproved}
%\end{figure}


\addchap[Stave IV: The Last of the Spirits]{Stave Four: The Last of the Spirits}
\begin{minipage}[c]{\linewidth}
...
\addchap[Stave V: The End of It]{Stave Five: The End of It}
\begin{minipage}[c]{\linewidth}
