...
\documentclass[paper=a5,twoside,DIV=calc,BCOR=5mm,usegeometry]{scrbook} % Document font size and paper size
\usepackage{graphicx}
\usepackage{xcolor}
\usepackage{fontspec}
...
\begin{figure}[tbh]
\centering
\includegraphics[width=.4\linewidth]{gs056}
\end{figure}
...
\begin{figure}[tbh]
\centering
\includegraphics[width=.4\linewidth]{gs182}
\end{figure}
\clearpage
