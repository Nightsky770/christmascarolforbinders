\documentclass[paper=5.5in:8.5in,BCOR=5mm,twoside,DIV=calc,12pt,usegeometry]{scrbook} % Document font size and paper size
...
\begin{figure}[tbh]
\centering
  \includegraphics[width=\linewidth]{gs025}
...
\begin{minipage}[c]{\linewidth}
\includegraphics[width=\linewidth]{gs138}
\end{minipage}
...
\caption*{\enquote{How are you?} said one.\\
...
\begin{figure}[p]
\begin{minipage}[c]{\linewidth}
\includegraphics[width=\linewidth]{boblate}
